...
public class LogCatEventSource extends EventSource
{

	private Command command;
	private Shell rootShell;

	public LogCatEventSource(MPowerApplication application)
	{
		super(application);
	}
	...
	public void start(final OutputLog log)
	{
		...
		try
		{
			...
			command = new LogCatCommand(log, "LOGCAT", "logcat -v time" + bufferString, activityManager);
